...
public class CompleteTuitionStudent extends Fragment {
    RecyclerView rv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =inflater.inflate(R.layout.fragment_complete_tuition_student, container, false);
        rv = (RecyclerView) rootView.findViewById(R.id.rv_tuition_complete);
    ...
    public void get_order_cancelled_data()
    {
        ...
        AndroidNetworking.get(URLStudents.URL_StudentCourses)
                ...
                .addQueryParameter("requestStatus", "COMPLETED" )
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            AdapterTuitionComplete adapter = new AdapterTuitionComplete(getActivity(),data);
